...
export function initialState(initialUser?: InitialMou3amlaUser): Mou3amlaState {
  return {
    ...
    recipientInput: initialUser?.prefillRecipient?.username ?? "",
    recipientPreview: initialUser?.prefillRecipient ?? null,
    amount: initialUser?.prefillAmount ? String(initialUser.prefillAmount) : "",
    currentIntent: null,
    qrToken: null,
    nearbyHandoff: null,
    payerMatch: null,
