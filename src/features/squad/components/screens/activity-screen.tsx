            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-[11px]" style={{ color: "rgba(244,245,246,0.4)" }}>
                    {item.wallet} · {item.date}
                  </div>
                </div>
                <div
                  className="font-mono text-[13.5px] font-semibold"
                  style={{ color: isSend ? squad.text : squad.green }}
                >
                  {isSend ? "-" : "+"}
